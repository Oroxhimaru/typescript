...
{
    /*✅ Example 2: in Operator for Objects
     */
...
{
    //✅ Example 4: Custom Type Guard (is keyword)
...
function handle(vehicle: Car | Bike) {
  if (isCar(vehicle)) {
